...
class TestFunctionalBucket:
    ...
    def test_functional_upload_image_get_metadata(self):
        ...
        image_metadata = upload_image_get_metadata(self.image_path, self.bucket_name, self.s3_path)
    ...
    def test_functional_upload_directory(self):
        ...
        upload_directory_response = upload_directory(image_dir_path, self.bucket_name, self.s3_path)
